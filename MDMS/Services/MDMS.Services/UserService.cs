...
namespace MDMS.Services
{
    public class UserService : IUserService
    {
        ...
        public async Task<MDMSUserServiceModel> GetCurrentUserByUsername(string username) => await Task.Run((() => 
            _context.Users.SingleOrDefault(u => username == u.UserName).To<MDMSUserServiceModel>()));
        ...
        public IQueryable<MDMSUserServiceModel> GetAllUsers() => 
            _context.Users.Where(x => x.UserName != "Root").OrderBy(x => x.Name).To<MDMSUserServiceModel>();
    }
}
